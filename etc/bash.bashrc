...
if ${use_color} ; then
        ...
        if [[ ${EUID} == 0 ]] ; then
                PS1='${debian_chroot:+($debian_chroot)}\[\033[01;31m\]\u@\h\[\033[01;34m\] \W\[\033[0;33m\]$(parse_git_branch)\[\033[01;34m\] \$\[\033[00m\] '
        else
                PS1='${debian_chroot:+($debian_chroot)}\[\033[01;32m\]\u@\h\[\033[01;34m\] \W\[\033[0;33m\]$(parse_git_branch) \[\033[01;34m\]\$\[\033[00m\] '
        fi
